console.log("Hello there! Im here. - from [app/speedtestAdditional] module.");
/*
	LibreSpeed - Main
	by Federico Dossena
...
Speedtest.prototype = {
  ...
  start: function() {
    ...
    this.worker = new Worker("plugins/app/speedtest_worker.js?r=" + Math.random());
