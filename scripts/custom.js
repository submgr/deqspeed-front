    ...
    function init_template(){
        ...
        */
        ...
        if(!addOfflineClasses.length){
            ...
            offlineAlert.className = 'offline-message bg-red-dark color-white text-left';
            offlineAlert.textContent = 'Нестабильное подключение к сети';
            onlineAlert.className = 'online-message bg-green-dark color-white text-left';
            onlineAlert.textContent = 'Подключение восстановлено';
